...
export const causeOptions: CauseOption[] = [
  {
    ...
    description: 'donations.causes.maintenanceDesc',
    icon: 'temple_hindu',
  ...
  },
  {
    ...
    description: 'donations.causes.annadanamDesc',
    icon: 'restaurant',
    iconColor: 'text-orange-500',
    iconBgColor: 'bg-orange-500/20',
  },
  {
    ...
    description: 'donations.causes.festivalsDesc',
    icon: 'handyman',
  ...
  },
  {
    ...
    description: 'donations.causes.customDesc',
    icon: 'edit_note',
